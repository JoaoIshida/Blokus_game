...
#AI, if is_ai and is_turn are both true
if __name__ == '__main__':
    ...
    pass_button.clicked.connect(next_player_clicked)

    confirm_button = QPushButton('Confirm', window)
    confirm_button.clicked.connect(confirm_placement)
    confirm_button.clicked.connect(next_player_clicked)
